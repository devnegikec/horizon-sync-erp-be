...
class TestListRoles:
    ...
    def test_list_roles_with_expired_token(self, client_no_override, db_session, expired_token):
...
class TestGetRole:
    ...
    def test_get_role_from_different_org(
        self, client_no_override, db_session, test_user_other_org, 
        test_org_role, access_token_other_user
    ):
...
class TestCreateRole:
    ...
    def test_create_role_without_permission(
        self, client_no_override, db_session, test_user_without_permission,
        test_organization, access_token
    ):
        ...
        headers = {"Authorization": f"Bearer {access_token}"}
        response = client_no_override.post("/api/v1/roles", json=role_data, headers=headers)
    ...
    def test_create_role_in_different_org(
        self, client_no_override, db_session, test_user_other_org,
        test_organization, access_token_other_user
    ):
...
class TestGetRolePermissions:
    ...
    def test_get_role_permissions_without_token(self, client_no_override, test_org_role):
...
class TestAssignPermissionToRole:
    ...
    def test_assign_permission_without_token(self, client_no_override, test_org_role, test_permissions):
        """Test that assign_permission returns 401 without auth token"""
        perm_data = {
            "permission_id": str(test_permissions["role.read"].id)
        }
    ...
    def test_assign_permission_without_permission(
        self, client_no_override, db_session, test_user_without_permission,
        test_org_role, test_permissions, access_token
    ):
    ...
    def test_assign_permission_to_system_role_as_non_admin(
        self, client_no_override, db_session, test_user_without_permission,
        test_system_role, test_permissions, access_token
    ):
    ...
    def test_assign_permission_success(self, client, test_org_role, test_permissions):
        ...
        perm_data = {
            "permission_id": str(test_permissions["roles:read"].id)
        }
...
class TestRemovePermissionFromRole:
    ...
    def test_remove_permission_without_token(self, client_no_override, test_org_role, test_permissions):
...
class TestBulkAssignPermissions:
    ...
    def test_bulk_assign_without_token(self, client_no_override, test_org_role, test_permissions):
...
class TestGetRoleUsers:
    ...
    def test_get_role_users_without_token(self, client_no_override, test_org_role, test_organization):
    ...
    def test_get_role_users_without_permission(
        self, client_no_override, db_session, test_user_without_permission,
        test_org_role, test_organization, access_token
    ):
    ...
    def test_get_role_users_from_different_org(
        self, client_no_override, db_session, test_user_other_org,
        test_org_role, test_organization, access_token_other_user
    ):
