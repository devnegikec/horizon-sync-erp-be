...
def upgrade() -> None:
    ...
    op.create_table('organizations',
        ...
        sa.Column('organization_type', postgresql.ENUM('enterprise', 'business', 'startup', 'individual', name='organizationtype', create_type=False), nullable=True),
        ...
        sa.Column('status', postgresql.ENUM('active', 'inactive', 'suspended', 'trial', name='organizationstatus', create_type=False), nullable=False),
    ...
    op.create_table('users',
        ...
        sa.Column('user_type', postgresql.ENUM('system_admin', 'organization_admin', 'user', 'guest', name='usertype', create_type=False), nullable=False),
        sa.Column('status', postgresql.ENUM('active', 'inactive', 'suspended', 'pending', name='userstatus', create_type=False), nullable=False),
        sa.Column('is_active', sa.Boolean(), nullable=False),
    ...
    op.create_table('permissions',
        ...
        sa.Column('name', sa.String(length=100), nullable=False),
        sa.Column('description', sa.Text(), nullable=True),
        sa.Column('resource', postgresql.ENUM('user', 'organization', 'team', 'role', 'permission', name='resourcetype', create_type=False), nullable=False),
        sa.Column('action', postgresql.ENUM('create', 'read', 'update', 'delete', 'manage', 'execute', name='actiontype', create_type=False), nullable=False),
    ...
    op.create_index(op.f('ix_user_organization_roles_role_id'), 'user_organization_roles', ['role_id'], unique=False)
