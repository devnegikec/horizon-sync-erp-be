...
from app.schemas.user import UserListResponse, UserListItem, PaginationMeta
...
async def list_users(
    ...
    status: Optional[str] = Query(None, description="Filter by status (active, inactive, suspended, pending)"),
    user_type: Optional[str] = Query(None, description="Filter by user type (system_admin, organization_admin, user, guest)"),
