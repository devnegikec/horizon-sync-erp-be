...
class BankingValidator:
    ...
    @classmethod
    def validate_account_number_format(cls, account_number: str, country_code: Optional[str] = None) -> bool:
...
class BankingSecurityUtils:
    ...
    def sanitize_banking_data(data: dict) -> dict:
        ...
        sensitive_fields = {
            ...
            'sort_code', 'bsb_number', 'bank_api_credentials_id'
        }
    ...
    def check_banking_permissions(user_roles: list, required_permission: str) -> bool:
        ...
        banking_permissions = {
            'view:banking_summary': ['accountant', 'finance_manager', 'treasurer', 'admin'],
