...
PICK_CONFIG_CATALOG: dict[str, dict[str, Any]] = {
    ...
    "require_bin_scan": {
        ...
        "description": "Picker must scan the source bin before picking, preventing items being picked from the wrong location.",
    },
    "require_sku_scan": {
        "type": BOOL,
        "default": True,
        "label": "Require SKU scan",
        "description": "Picker must scan the SKU or item code before each pick.",
    },
    "require_serial": {
        "type": ENUM,
        "default": "per_item",
        ...
        "description": "When serial numbers must be scanned: per item, always, or never.",
    },
    "over_pick_tolerance": {
        "type": NUMERIC,
        "default": 0,
        "label": "Over-pick tolerance",
        "description": "Extra quantity allowed above the requested amount before a pick exception is raised.",
    },
    "allow_short_pick": {
        "type": BOOL,
        "default": True,
        "label": "Allow short pick",
        "description": "Allow completing a line with less than the requested quantity.",
    },
    "short_pick_approval_threshold": {
        "type": NUMERIC,
        "default": 0,
        "label": "Short-pick approval threshold",
        "description": "Short-pick variance above this value requires supervisor approval.",
    },
    "require_stage_scan": {
        "type": BOOL,
        "default": False,
        "label": "Require staging scan",
        "description": "Picker must scan the staging lane before completing the pick.",
    },
    "enable_handling_unit": {
        "type": BOOL,
        "default": False,
        "label": "Enable handling units",
        "description": "Allow associating a trolley, carton, or pallet with a pick line.",
    },
    "aging_threshold_minutes": {
        "type": INT,
        "default": 120,
        "label": "Aging threshold (minutes)",
        "description": "Number of minutes before an open task is flagged as aging.",
    },
    "login_lockout_attempts": {
        "type": INT,
        "default": 5,
        "label": "Login lockout attempts",
        "description": "Number of failed handheld logins before the worker is locked out.",
    },
    "session_timeout_minutes": {
        "type": INT,
        "default": 30,
        "label": "Session timeout (minutes)",
        "description": "Idle session timeout for handheld devices.",
    },
    "reason_codes": {
        "type": LIST,
        "default": DEFAULT_REASON_CODES,
        "label": "Reason codes",
        "description": "Master list of pick exception reason codes.",
    },
    "priority_fields": {
        "type": LIST,
        "default": [],
