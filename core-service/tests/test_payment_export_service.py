...
class TestExportToExcel:
    ...
    def test_export_to_excel_creates_valid_workbook(
        self, export_service, organization_id
    ):
        """Test that Excel export creates a valid workbook"""
        # Export to Excel
        excel_data = export_service.export_to_excel(
            organization_id=organization_id, organization_name="Test Organization"
        )
    ...
    def test_summary_sheet_contains_organization_name(
        self, export_service, organization_id
    ):
        """Test that summary sheet includes organization branding"""
        excel_data = export_service.export_to_excel(
            organization_id=organization_id, organization_name="ACME Corporation"
        )
    ...
    def test_summary_sheet_contains_report_title(self, export_service, organization_id):
        ...
        excel_data = export_service.export_to_excel(
            organization_id=organization_id, organization_name="Test Org"
        )
    ...
    def test_summary_sheet_contains_status_breakdown(
        self, export_service, organization_id
    ):
    ...
    def test_summary_sheet_contains_mode_breakdown(
        self, export_service, organization_id
    ):
    ...
    def test_unallocated_sheet_contains_only_unallocated_payments(
        self, export_service, organization_id
    ):
