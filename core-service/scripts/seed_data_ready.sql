...
--    \c core_db;
--
-- 2. Replace the UUIDs below (lines 20-21) with the actual values
-- 3. Run this script: \i seed_data_ready.sql
--
-- OR use this one-liner:
-- docker compose exec postgres psql -U horizon_user -d core_db -v org_id="'your-uuid'" -v admin_id="'your-uuid'" -f /app/scripts/seed_data_ready.sql
-- ===========================================

\c core_db;

-- ===========================================
-- REPLACE THESE UUIDs (get from identity_db)
-- ===========================================
-- Get them with:
--   \c identity_db;
--   SELECT id FROM organizations WHERE slug = 'default-org';
