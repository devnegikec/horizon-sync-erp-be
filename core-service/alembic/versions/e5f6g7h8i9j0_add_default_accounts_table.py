...
def upgrade() -> None:
    ...
    op.execute("CREATE INDEX IF NOT EXISTS idx_default_accounts_transaction_type ON default_accounts (transaction_type)")
    op.execute("CREATE INDEX IF NOT EXISTS idx_default_accounts_scenario ON default_accounts (scenario)")
    op.execute("CREATE INDEX IF NOT EXISTS idx_default_accounts_organization_id ON default_accounts (organization_id)")
