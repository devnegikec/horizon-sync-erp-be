...
def upgrade() -> None:
    ...
    op.execute("CREATE INDEX IF NOT EXISTS idx_audit_account ON account_audit_log (account_id)")
    op.execute("CREATE INDEX IF NOT EXISTS idx_audit_timestamp ON account_audit_log (timestamp)")
    op.execute("CREATE INDEX IF NOT EXISTS idx_audit_user ON account_audit_log (user_id)")
