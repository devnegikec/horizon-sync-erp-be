...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "stock_entry_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("stock_entries.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "item_id",
        ...
        sa.Column(
            "quality_inspection_id", postgresql.UUID(as_uuid=True), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "performed_at", sa.DateTime(timezone=True), server_default=sa.func.now()
        ),
        sa.Column(
            "created_at", sa.DateTime(timezone=True), server_default=sa.func.now()
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "reconciliation_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("stock_reconciliations.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "item_id",
