...
def upgrade() -> None:
    ...
    op.execute("CREATE INDEX IF NOT EXISTS idx_account_balances_account_id ON account_balances (account_id)")
    op.execute("CREATE INDEX IF NOT EXISTS idx_account_balances_as_of_date ON account_balances (as_of_date)")
    op.execute("CREATE INDEX IF NOT EXISTS idx_account_balances_account_date ON account_balances (account_id, as_of_date)")
