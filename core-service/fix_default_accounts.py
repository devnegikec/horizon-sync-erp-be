...
def main():
    ...
    with engine.connect() as conn:
        ...
        if not mappings:
            ...
            print("Option 2: Create manually with SQL (see FIX_DEFAULT_ACCOUNTS_MANUAL.md)")
            return
        ...
        if broken_mappings:
            ...
            for mapping in broken_mappings:
                ...
                print(f"UPDATE default_accounts")
                print(f"SET account_id = '<your-account-id-from-step-1>'")
...
if __name__ == "__main__":
    try:
        ...
        print("  3. Database URL: postgresql://horizon_user:horizon_pass@localhost:5432/core_db")
