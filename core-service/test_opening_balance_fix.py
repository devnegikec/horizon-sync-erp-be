...
def test_opening_balance_schema():
    ...
    assert hasattr(create_data, 'opening_balance'), "opening_balance field should be accessible"
    assert create_data.opening_balance == 1000.0, f"opening_balance should be 1000.0, got {create_data.opening_balance}"
...
if __name__ == "__main__":
    ...
    if success1 and success2:
        ...
        print("  ✅ Schemas handle various opening_balance scenarios (None, negative, etc.)")
        print()
        print("Next steps:")
